	...
	<form action="" method="post" name="manageservice">
			<table width="100%" class="table" >
			   <tr>
				...
				<td>&nbsp;</td>
				<td><input name="name" type="text" id="name"  value="<?php echo $servicedetails1->name; ?>" class="inputheight"/>&nbsp;<a href="#" rel="tooltip" title="Service Name." ><i class="icon-question-sign"></i></a></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				</select>&nbsp;<a href="#" rel="tooltip" title="Duration Unit." ><i class="icon-question-sign"></i></a>
				</td>
			  </tr>
			  <tr>
				<th scope="row"><strong>Cost</strong></th>
				<td>&nbsp;</td>
				<td><input name="cost" type="text" id="cost" value="<?php echo $servicedetails1->cost; ?>" class="inputheight"/>&nbsp;<a href="#" rel="tooltip" title="Service Cost, Enter Numeric Value eg: 50, 100, 150." ><i class="icon-question-sign"></i></a>
				</td>
			  </tr>
			  <tr>
				...
				</select>&nbsp;<a href="#" rel="tooltip" title="Service Availability." ><i class="icon-question-sign"></i></a>
				</td>
			  </tr>
			  <tr>
				...
				<td><select id="category" name="category">
					  ...
					  <?php //get all category list					 	
						...
						<?php } ?>
					</select>&nbsp;<a href="#" rel="tooltip" title="Service Category." ><i class="icon-question-sign"></i> </a>
				</td>
			  </tr>
			  <tr>
				<th scope="row">&nbsp;</th>
