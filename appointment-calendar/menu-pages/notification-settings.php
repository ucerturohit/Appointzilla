...
<table width="100%" class="table">
  ...
  <tr>
    ...
    <td><strong>:</strong></td>
    <td><em><?php if($emaildetails['wpemail'])echo $emaildetails['wpemail']; else echo "Not Available"; ?></em></td>
  </tr>
  <?php } ?>
  ...
  <tr>
    ...
    <td><strong>:</strong></td>
    <td><em><?php if($emaildetails['phpemail'])echo $emaildetails['phpemail']; else echo "Not Available";  ?></em></td>
  </tr>
  <?php } ?>
  ...
  <tr>
    ...
    <td><strong>:</strong></td>
    <td><em><?php if($emaildetails['hostname'])echo $emaildetails['hostname']; else echo "Not Available"; ?></em></td>
  </tr>
  <tr>
    <th scope="row">&nbsp;</th>
    <td scope="row">Port Number</td>
    <td><strong>:</strong></td>
    <td><em><?php if($emaildetails['portno'])echo $emaildetails['portno']; else echo "Not Available"; ?></em></td>
  </tr>
  <tr>
    <th scope="row">&nbsp;</th>
    <td scope="row">Email</td>
    <td><strong>:</strong></td>
    <td><em><?php if($emaildetails['smtpemail'])echo $emaildetails['smtpemail']; else echo "Not Available"; ?></em></td>
  </tr>
  <tr>
    <th scope="row">&nbsp;</th>
    <td scope="row">Password</td>
    <td><strong>:</strong></td>
    <td><em><?php if($emaildetails['password'])echo "******"; else echo "Not Available"; ?></em></td>
  </tr>
  <?php } ?>
  <tr>
