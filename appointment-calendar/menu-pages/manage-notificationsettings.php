...
<form name="emailsettings" action="?page=notificationsettings"  method="post">
  ...
  <tr>
    ...
    <td width="69%"><input name="enable" type="checkbox" id="enable" <?php if(get_option('emailstatus') == 'on') echo 'checked'; ?> />&nbsp;<a href="#" rel="tooltip" title="Enable Notification." ><i class="icon-question-sign"></i> </a>
	</td>
    <td width="3%">&nbsp;</td>
    <td width="3%">&nbsp;</td>
    <td width="3%">&nbsp;</td>
  ...
  <tr>
    ...
    <td>
      ...
      </select>&nbsp;<a href="#" rel="tooltip" title="Notification Type." ><i class="icon-question-sign"></i></a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<!--wp mail-->
  ...
  <tr id="wpmaildetails2" style="display:none;">
    ...
    <td><strong>:</strong></td>
    <td><input name="wpemail" type="text" id="wpemail"  value="<?php echo $emaildetails['wpemail']; ?>" />&nbsp;<a href="#" rel="tooltip" title="Admin Email." ><i class="icon-question-sign"></i></a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr id="phpmaildetails2" style="display:none;">
    ...
    <th scope="row">Email</th>
    <td><strong>:</strong></td>
    <td><input name="phpemail" type="text" id="phpemail" value="<?php echo $emaildetails['phpemail']; ?>" />&nbsp;<a href="#" rel="tooltip" title="Admin Email." ><i  class="icon-question-sign"></i></a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<!--smtp-->
  ...
  <tr id="smtpdetails2" style="display:none;">
    ...
    <td><strong>:</strong></td>
    <td><input name="hostname" type="text" id="hostname" class="inputhieght" value="<?php echo $emaildetails['hostname']; ?>" />&nbsp;<a href="#" rel="tooltip" title="Host Name Like eg: smtp.gmail.com, smtp.yahoo.com." ><i class="icon-question-sign"></i></a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr id="smtpdetails3" style="display:none;">
    ...
    <td><strong>:</strong></td>
    <td><input name="portno" type="text" id="portno" value="<?php echo $emaildetails['portno']; ?>" />&nbsp;<a href="#" rel="tooltip" title="Smtp Post Number Like eg: Gmail & Yahoo Port Number = 465." ><i class="icon-question-sign"></i></a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr id="smtpdetails4" style="display:none;">
    ...
    <td><strong>:</strong></td>
    <td><input name="smtpemail" type="text" id="smtpemail" value="<?php echo $emaildetails['smtpemail']; ?>" />&nbsp;<a href="#" rel="tooltip" title="Admin SMTP Email." ><i class="icon-question-sign"></i></a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr id="smtpdetails5" style="display:none;">
    ...
    <td><strong>:</strong></td>
    <td><input name="password" type="password" id="password" value="<?php echo $emaildetails['password']; ?>" />&nbsp;<a href="#" rel="tooltip" title="Admin SMTP Email Password." ><i class="icon-question-sign"></i></a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
