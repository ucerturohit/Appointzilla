...
<form method="post" action="?page=settings">
  ...
  <tr>
	...
	<?php $calendar_slot_time = get_option('calendar_slot_time'); ?>
      ...
      </select>&nbsp;<a href="#" rel="tooltip" title="Calendar Time Slot." ><i class="icon-question-sign"></i></a> 
	 </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>
		...
		<select name="day_start_time" id="day_start_time">
			...
			?>
		</select>&nbsp;<a href="#" rel="tooltip" title="Calendar Day Start Time." ><i class="icon-question-sign"></i> </a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>
		...
		<select name="day_end_time" id="day_end_time">
			...
			?>
		</select>&nbsp;<a href="#" rel="tooltip" title="Calendar Day End Time." ><i class="icon-question-sign"></i> </a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>
		...
		</select>&nbsp;<a href="#" rel="tooltip" title="Calendar View." ><i class="icon-question-sign"></i> </a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    </select>&nbsp;<a href="#" rel="tooltip" title="Calendar First Day." ><i class="icon-question-sign"></i> </a>
    </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
